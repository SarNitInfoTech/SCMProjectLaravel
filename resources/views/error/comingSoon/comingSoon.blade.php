<div class="grid grid-cols-12 authentication p-[3rem] under-maintenance mx-0 text-defaulttextcolor text-defaultsize">
            <div class="xxl:col-span-5 xl:col-span-4 lg:col-span-4 lg:block hidden px-0">
                <div class="primary-background w-full h-full flex items-center justify-center under-maintenance-image-container">
                    <img src="https://laravelui.spruko.com/tailwind/valex/build/assets/images/authentication/8.png" alt="" class="imig-fluid">
                </div>
            </div>
                ...
                <div class="grid grid-cols-12 items-center h-full text-center">
                    ...
                    <div class="xxl:col-span-6 xl:col-span-6 lg:col-span-6 md:col-span-6 sm:col-span-8 col-span-12">
                        <div class="mb-2 flex justify-center">
                            <a href="https://laravelui.spruko.com/tailwind/valex/index">
                                <img src="https://laravelui.spruko.com/tailwind/valex/build/assets/images/brand-logos/toggle-logo.png" alt="" class="authentication-brand">
                            </a>
                        </div>
                        ...
                        <div class="grid grid-cols-12 mt-6 xxl:gap-y-0 gap-4 mb-[3rem]" id="timer"><div class="xxl:col-span-3 xl:col-span-6 lg:col-span-6 md:col-span-3 sm:col-span-6 col-span-6"><div class="p-3 border-2 border-dashed border-defaultborder dark:border-defaultborder/10 rounded-md"><p class="mb-1 text-[0.75rem] opacity-[0.5]">DAYS</p><h4 class="font-semibold mb-0 text-[1.5rem]">-595</h4></div></div><div class="xxl:col-span-3 xl:col-span-6 lg:col-span-6 md:col-span-3 sm:col-span-6 col-span-6"><div class="p-3 border-2 border-dashed border-defaultborder dark:border-defaultborder/10 rounded-md"><p class="mb-1 text-[0.75rem] opacity-[0.5]">HOURS</p><h4 class="font-semibold mb-0 text-[1.5rem]">23</h4></div></div><div class="xxl:col-span-3 xl:col-span-6 lg:col-span-6 md:col-span-3 sm:col-span-6 col-span-6"><div class="p-3 border-2 border-dashed border-defaultborder dark:border-defaultborder/10 rounded-md"><p class="mb-1 text-[0.75rem] opacity-[0.5]">MINUTES</p><h4 class="font-semibold mb-0 text-[1.5rem]">1</h4></div></div><div class="xxl:col-span-3 xl:col-span-6 lg:col-span-6 md:col-span-3 sm:col-span-6 col-span-6"><div class="p-3 border-2 border-dashed border-defaultborder dark:border-defaultborder/10 rounded-md"><p class="mb-1 text-[0.75rem] opacity-[0.5]">SECONDS</p><h4 class="font-semibold mb-0 text-[1.5rem]">39</h4></div></div></div>
