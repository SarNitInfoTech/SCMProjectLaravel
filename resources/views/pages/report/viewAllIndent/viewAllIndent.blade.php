    ...
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 24px; flex-wrap: wrap; gap: 16px;">
        <div style="display: flex; align-items: center; gap: 14px;">
            ...
            <div>
                ...
                <p style="font-size: 13px; color: #64748B; margin: 0; font-weight: 500;">Report of all indents registered in the system</p>
            </div>
        </div>
    ...
    <div style="background: #FFFFFF; border: 1px solid #E2E8F0; border-radius: 16px; box-shadow: 0 4px 20px rgba(0,0,0,0.03); overflow: hidden; margin-bottom: 24px;">
        ...
        <div style="padding: 20px; border-bottom: 1px solid #F1F5F9; display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 16px; background: #FAFAFA;">
            <div style="display: flex; align-items: center; gap: 10px;">
                ...
                <h2 style="font-size: 18px; font-weight: 800; color: #0F172A; margin: 0;">All Indents Report</h2>
            </div>
            ...
            <form method="GET" action="{{ route('report.viewAllIndent') }}" style="display: flex; align-items: center; gap: 10px; flex-wrap: wrap;">
                ...
                <div style="position: relative; width: 340px;">
                    ...
                    <input type="text" name="search" value="{{ request('search') }}" placeholder="Search ID, department, project..." 
        ...
        <div style="width: 100%; overflow-x: auto; -webkit-overflow-scrolling: touch;">
            <table style="width: 100%; min-width: 1000px; border-collapse: collapse; text-align: left; font-size: 13px; table-layout: fixed;" id="indent-report-table">
                <thead>
                    <tr style="background: #F8FAFC; border-bottom: 1px solid #E2E8F0; color: #64748B; font-size: 11px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px;">
                        ...
                        <th style="padding: 14px 16px; width: 180px; vertical-align: middle;">DEPARTMENT <span style="color:#CBD5E1;">↕</span></th>
                        <th style="padding: 14px 16px; width: 160px; vertical-align: middle;">PROJECT <span style="color:#CBD5E1;">↕</span></th>
                        <th style="padding: 14px 16px; vertical-align: middle;">ITEMS <span style="color:#CBD5E1;">↕</span></th>
                        <th style="padding: 14px 16px; width: 160px; text-align: center; vertical-align: middle;">STATUS <span style="color:#CBD5E1;">↕</span></th>
                        <th style="padding: 14px 16px; width: 140px; vertical-align: middle;">INDENT DATE <span style="color:#CBD5E1;">↕</span></th>
                    </tr>
                </thead>
                <tbody>
                    @forelse ($rows as $row)
                        ...
                        <tr style="border-bottom: 1px solid #F1F5F9; transition: background 0.15s ease;" onmouseover="this.style.background='#F8FAFC'" onmouseout="this.style.background='#FFFFFF'">
                            ...
                            <!-- Department Name -->
                            <td style="padding: 16px; vertical-align: middle; color: #475569; font-weight: 600; white-space: nowrap;">{{ $row['indent_department'] }}</td>
                            
                            <!-- Project -->
                            <td style="padding: 16px; vertical-align: middle; color: #0F172A; font-weight: 700; white-space: nowrap;">{{ $row['indent_project'] }}</td>
                            
                            <!-- Items -->
                            <td style="padding: 16px; vertical-align: middle; color: #334155; font-weight: 500; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;" title="{{ $row['items_text'] }}">{{ $row['items_text'] }}</td>
                    ...
                    @empty
                        <tr>
                            <td colspan="6" style="text-align: center; padding: 32px; color: #64748B; font-weight: 600;">No indent records found.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
