...
<div class="md:flex block items-center justify-between my-6 page-header-breadcrumb">
    ...
    <div class="flex items-center gap-2">
        <a href="{{ route('bulk-upload.index', ['module' => 'items']) }}" class="px-4 py-2 text-sm bg-green-600 hover:bg-green-700 text-white rounded shadow transition-all flex items-center gap-1.5">
                ...
                @forelse ($items as $item)
                    <tr class="border-b border-defaultborder hover:bg-gray-50 transition-colors">
                        ...
                        <td class="text-center">
                            ...
                            <form action="{{ route('items.destroy', $item->id) }}" method="POST" class="inline-block" onsubmit="return confirm('Are you sure you want to delete this item?')">
                                @csrf
                                @method('DELETE')
