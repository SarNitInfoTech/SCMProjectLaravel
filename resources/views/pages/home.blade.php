                    ...
                    <div class="grid grid-cols-12 gap-x-6">
                        <div class="md:col-span-12 lg:col-span-12 xl:col-span-7 col-span-12">
                            ...
                            <div class="box-header !border-b-0 !pb-0 flex justify-between">
                                ...
                                <a aria-label="anchor" href="javascript:void(0);" class="flex items-center justify-center w-[1.75rem] h-[1.75rem] !text-defaulttextcolor !text-[0.8rem] !pt-1 !pb-[0.1rem] !px-2 avatar-rounded border border-light shadow-none !font-[500]" data-bs-toggle="dropdown" aria-expanded="false"><i class="fe fe-more-horizontal text-[0.8rem]"></i>
                                </a>
                                <ul class="hs-dropdown-menu z-[106] ti-dropdown-menu hidden">
                                    <li><a class="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-[500] block" href="javascript:void(0);">Action</a></li>
                                    <li><a class="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-[500] block" href="javascript:void(0);">Another action</a></li>
                                    <li><a class="ti-dropdown-item !py-2 !px-[0.9375rem] !text-[0.8125rem] !font-[500] block" href="javascript:void(0);">Something else here</a></li>
                                </ul>
                                </div>
                            </div>
                                ...
                                <div class="box-body !p-0 customers mt-1">
                                    <div class="ti-list-group ti-list-group-flush">
                                        <div class="ti-list-group-item !border-t-0 !border-l-0 !border-r-0 font-medium">
                                            <div class="flex">
                                                <img class="avatar avatar-md avatar-rounded my-auto me-4" src="images/3.jpg" alt="Image description">
                                                <div class="flex-grow">
                                        ...
                                        <div class="ti-list-group-item !border-t-0 !border-l-0 !border-r-0 font-medium">
                                            <div class="flex">
                                                <img class="avatar avatar-md avatar-rounded my-auto me-4" src="images/11.jpg" alt="Image description">
                                                <div class="flex-grow">
                                                    <div class="flex items-center">
                                                        <div class="mt-1">
                                        ...
                                        <div class="ti-list-group-item !border-t-0 !border-l-0 !border-r-0 font-medium">
                                            <div class="flex">
                                                <img class="avatar avatar-md avatar-rounded my-auto me-4" src="images/17.jpg" alt="Image description">
                                                <div class="flex-grow">
                                                    <div class="flex items-center">
                                                        <div class="mt-1">
                                        ...
                                        <div class="ti-list-group-item !border-t-0 !border-l-0 !border-r-0 font-medium">
                                            <div class="flex">
                                                <img class="avatar avatar-md avatar-rounded my-auto me-4" src="images/15.jpg" alt="Image description">
                                                <div class="flex-grow">
                                                    <div class="flex items-center">
                                                        <div class="mt-1">
                                        ...
                                        <div class="ti-list-group-item !border-t-0 !border-l-0 !border-r-0 font-medium">
                                            <div class="flex">
                                                <img class="avatar avatar-md avatar-rounded my-auto me-4" src="images/6.jpg" alt="Image description">
                                                <div class="flex-grow">
                                                    <div class="flex items-center">
                                                        <div class="mt-1">
                        ...
                        <div class="md:col-span-12 lg:col-span-8 xl:col-span-8 col-span-12">
                            <div class="box !p-[20px]">
                                <div class=" box-header !border-b-0 !p-0 flex justify-between">
                                    ...
                                    <div class="hs-dropdown ti-dropdown">
                                    <a aria-label="anchor" href="javascript:void(0);" class="flex items-center justify-center w-[1.75rem] h-[1.75rem] !text-defaulttextcolor !text-[0.8rem] !py-1 !px-2 avatar-rounded border border-light shadow-none !font-[500]" data-bs-toggle="dropdown" aria-expanded="false"><i class="fe fe-more-horizontal text-[0.8rem]"></i>
                                    </a>
