<div class="w-full px-4 py-6 bg-white shadow rounded">
    <form method="POST" action="{{ route('vendors.update', $vendor->id) }}" enctype="multipart/form-data"
        ...
        <div>
            ...
            <input type="text" name="pan_number" id="pan_number" value="{{ old('pan_number', $vendor->pan_number) }}"
                class="form-control w-full text-black font-normal rounded border border-gray-300 p-2"
        ...
        <div>
            ...
            <input type="text" name="account_name" id="account_name" value="{{ old('account_name', $vendor->account_name) }}"
                class="form-control w-full text-black font-normal rounded border border-gray-300 p-2"
        ...
        <div>
            ...
            <input type="text" name="bank_name" id="bank_name" value="{{ old('bank_name', $vendor->bank_name) }}"
                class="form-control w-full text-black font-normal rounded border border-gray-300 p-2"
        ...
        <div>
            ...
            <input type="text" name="branch_name" id="branch_name" value="{{ old('branch_name', $vendor->branch_name) }}"
                class="form-control w-full text-black font-normal rounded border border-gray-300 p-2"
        ...
        <div>
            ...
            <input type="text" name="ifsc_code" id="ifsc_code" value="{{ old('ifsc_code', $vendor->ifsc_code) }}"
                class="form-control w-full text-black font-normal rounded border border-gray-300 p-2"
        ...
        <div class="col-span-4 sm:col-span-2">
            ...
            <div class="form-control text-black font-normal rounded border border-gray-300 p-2 flex items-center gap-3">
                <input type="checkbox" name="is_active" id="is_active" class="hidden" {{ $vendor->is_active ? 'checked' : '' }}>
                <div id="toggle-active" class="toggle toggle-success cursor-pointer mb-1 {{ $vendor->is_active ? 'on' : '' }}">
                    <span></span>
                </div>
