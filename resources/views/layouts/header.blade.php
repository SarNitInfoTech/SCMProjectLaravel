  <!-- Main-Header -->
					...
					<nav class="main-header" aria-label="Global">
						...
						<div class="header-content-left">
							...
							<div class="horizontal-logo">
								<a href="https://laravelui.spruko.com/tailwind/valex/index" class="header-logo">
								<img src="images/desktop-logo.png" alt="logo" class="desktop-logo">
								<img src="images/toggle-logo.png" alt="logo" class="toggle-logo">
								<img src="images/desktop-dark.png" alt="logo" class="desktop-dark">
								<img src="images/toggle-dark.png" alt="logo" class="toggle-dark">
								<img src="images/desktop-white.png" alt="logo" class="desktop-white">
								</a>
							</div>
							</div>
							<!-- End::header-element -->
						...
						<div class="header-content-right">
							...
							<div class="hs-dropdown-menu ti-dropdown-menu min-w-[10rem] hidden !left-[-7rem] !-mt-2" aria-labelledby="dropdown-flag">
								...
								<div class="py-2 first:pt-0 last:pb-0">
									...
									<div class="flex items-center space-x-2 rtl:space-x-reverse w-full">
										...
										<img src="images/french_flag.jpg" alt="flag-img" class="h-[1.1875rem] w-[1.1875rem] rounded-full">
										</div>
										<div>
									...
									<div class="flex items-center space-x-2 rtl:space-x-reverse w-full">
										<div class="flex items-center rounded-full">
										<img src="images/germany_flag.jpg" alt="flag-img" class="h-[1.1875rem] w-[1.1875rem] rounded-full">
										</div>
										<div>
										<p class="!text-[0.8125rem] font-medium">
											German
									...
									<div class="flex items-center space-x-2 rtl:space-x-reverse w-full">
										<div class="flex items-center rounded-full">
										<img src="images/italy_flag.jpg" alt="flag-img" class="h-[1.1875rem] w-[1.1875rem] rounded-full">
										</div>
										<div>
										<p class="!text-[0.8125rem] font-medium">
											Italian
									...
									<div class="flex items-center space-x-2 rtl:space-x-reverse w-full">
										<div class="flex items-center rounded-full">
										<img src="images/russia_flag.jpg" alt="flag-img" class="h-[1.1875rem] w-[1.1875rem] rounded-full">
										</div>
										<div>
										<p class="!text-[0.8125rem] font-medium">
											Russian
									...
									<div class="flex items-center space-x-2 rtl:space-x-reverse w-full">
										<div class="flex items-center rounded-full">
										<img src="images/spain_flag.jpg" alt="flag-img" class="h-[1.1875rem] w-[1.1875rem] rounded-full">
										</div>
										<div>
										<p class="!text-[0.8125rem] font-medium">
											Spanish
							...
							<div class="header-element py-[1rem] px-[0.65rem] notifications-dropdown header-notification hs-dropdown ti-dropdown !hidden md:!flex [--placement:bottom-right]">
								<button id="dropdown-cart" type="button" class="hs-dropdown-toggle relative ti-dropdown-toggle !p-0 !border-0 flex-shrink-0  !rounded-full !shadow-none align-middle text-xs">
									...
									<span class="animate-slow-ping absolute inline-flex -top-[0.15rem] start-[16px] h-[10px] w-[10px] !rounded-full bg-danger/50 opacity-75"></span>
									<span class="pulse-danger"></span>
								</button>

								<div class="main-header-dropdown !-mt-2 !p-0 hs-dropdown-menu ti-dropdown-menu  bg-white !w-[20rem] !border-0 border-defaultborder hidden !m-0" aria-labelledby="dropdown-cart">
									...
									<li class="dropdown-item">
										...
										<div>
											<div class="flex">
											<a href="https://laravelui.spruko.com/tailwind/valex/chat">
									...
									<a href="https://laravelui.spruko.com/tailwind/valex/chat" class="text-primary text-[.8125rem]">VIEW ALL</a>
									</div>
								</div>
							</div>
							...
							<div class="header-element md:!px-[0.5rem] px-2 hs-dropdown profile-dropdown !items-center ti-dropdown [--placement:bottom-right]">
								...
								<button id="dropdown-profile" type="button" class="hs-dropdown-toggle ti-dropdown-toggle !gap-2 !p-0 flex-shrink-0 me-0 !rounded-full !shadow-none text-xs align-middle !border-0 !shadow-transparent ">
									<img class="inline-block rounded-full " src="images/6.jpg" width="37" height="37" alt="Image Description">
								</button>
								<div class="main-header-dropdown !-mt-2 !p-0 hs-dropdown-menu ti-dropdown-menu  bg-white  !border-0 border-defaultborder hidden !m-0 " aria-labelledby="dropdown-profile">
									...
									<ul class="dropdown-menu pt-0 header-profile-dropdown dropdown-menu-end main-profile-menu" aria-labelledby="mainHeaderProfile">
									<li>
										<div class="main-header-profile bg-primary menu-header-content text-white">
										<div class="my-auto">
											<h6 class="mb-0 leading-none text-white">Petey Cruiser</h6><span class="text-[.6875rem] opacity-[0.7] leading-none">Premium Member</span>
										</div>
										</div>
									</li>
									<li><a class="dropdown-item text-defaulttextcolor flex " href="https://laravelui.spruko.com/tailwind/valex/profile"><i class="bx bx-user-circle text-[1.125rem] me-2 opacity-[0.7]"></i>Profile</a></li>
									<li><a class="dropdown-item text-defaulttextcolor flex " href="https://laravelui.spruko.com/tailwind/valex/profile"><i class="bx bx-cog text-[1.125rem] me-2 opacity-[0.7]"></i>Edit Profile </a></li>
									<li><a class="dropdown-item text-defaulttextcolor flex  border-block-end" href="https://laravelui.spruko.com/tailwind/valex/mail"><i class="bx bxs-inbox text-[1.125rem] me-2 opacity-[0.7]"></i>Inbox</a></li>
									<li><a class="dropdown-item text-defaulttextcolor flex " href="https://laravelui.spruko.com/tailwind/valex/chat"><i class="bx bx-envelope text-[1.125rem] me-2 opacity-[0.7]"></i>Messages</a></li>
									<li><a class="dropdown-item text-defaulttextcolor flex  border-block-end" href="https://laravelui.spruko.com/tailwind/valex/profile"><i class="bx bx-slider-alt text-[1.125rem] me-2 opacity-[0.7]"></i>Account Settings</a></li>
									<li><a class="dropdown-item text-defaulttextcolor !rounded-bl-md !rounded-br-md flex " href="https://laravelui.spruko.com/tailwind/valex/sign-in-basic"><i class="bx bx-log-out text-[1.125rem] me-2 opacity-[0.7]"></i>Sign Out</a>
									</li>
									</ul>
								</div>
							</div>
							...
							<button aria-label="button" type="button" class="hs-dropdown-toggle switcher-icon inline-flex flex-shrink-0 justify-center items-center gap-2  rounded-full font-medium  align-middle transition-all text-xs dark:text-white/70 dark:hover:text-white dark:focus:ring-white/10 dark:focus:ring-offset-white/10" data-hs-overlay="#hs-overlay-switcher">
								<svg xmlns="http://www.w3.org/2000/svg" class="header-link-icon animate-spin-slow" width="24" height="24" viewBox="0 0 24 24">
			...
			<div id="videomodal" class="hs-overlay hidden ti-modal">
				<div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out">
					...
					<div class="mx-auto text-center p-[3rem]">
						<button type="button" class="hs-dropdown-toggle relative -end-[226px] -top-[29px] !text-[1.5rem] !font-medium text-white" data-hs-overlay="#videomodal">
						<span class="sr-only">Close</span>
						<i class="bi bi-x"></i>
						</button>
						<h5 class="text-white">Valex Video call</h5>
						<img src="images/6.jpg" class="rounded-full !h-[90px]  mt-4 mb-3 inline-flex" alt="img">
						...
						<div class="grid grid-cols-12 gap-x-4">
							...
							<div class="col-span-4">
							<a class="icon icon-shape rounded-full text-white mb-0" href="javascript:void(0);" data-hs-overlay="#videomodal">
			...
			<div id="audiomodal" class="hs-overlay hidden ti-modal">
				<div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out">
					...
					<div class="mx-auto text-center p-[3rem]">
						<button type="button" class="hs-dropdown-toggle relative -end-[226px] -top-[29px] !text-[1.5rem] !font-medium text-[#8c9097]" data-hs-overlay="#audiomodal">
						<span class="sr-only">Close</span>
						<i class="bi bi-x"></i>
						</button>
						<h6 class="text-defaulttextcolor dark:text-defaulttextcolor/70">Valex Voice call</h6>
						<img src="images/6.jpg" class="rounded-full !h-[90px] mt-6 mb-4 inline-flex" alt="img">
						...
						<div class="grid grid-cols-12 gap-x-4">
							...
							<div class="col-span-4">
							<a class="icon icon-shape rounded-circle text-white mb-0" href="javascript:void(0);" data-hs-overlay="#audiomodal">
						...
						<ul class="main-menu">
							...
							<li class="slide has-sub">
								...
								<ul class="slide-menu child1">
									...
									<li class="slide">
										<a href="https://laravelui.spruko.com/tailwind/valex/index" class="side-menu__item">Sales</a>
									</li>
									<li class="slide">
										<a href="https://laravelui.spruko.com/tailwind/valex/index1" class="side-menu__item">Ecommerce</a>
									</li>
									<li class="slide">
										<a href="https://laravelui.spruko.com/tailwind/valex/index2" class="side-menu__item">Crm</a>
									</li>
									<li class="slide">
										<a href="https://laravelui.spruko.com/tailwind/valex/index3" class="side-menu__item">Crypto</a>
									</li>
									<li class="slide">
										<a href="https://laravelui.spruko.com/tailwind/valex/index4" class="side-menu__item">NFT</a>
									</li>
									<li class="slide">
										<a href="https://laravelui.spruko.com/tailwind/valex/index5" class="side-menu__item">Analytics</a>
									</li>
									<li class="slide">
										<a href="https://laravelui.spruko.com/tailwind/valex/index6" class="side-menu__item">HRM</a>
									</li>
									<li class="slide">
										<a href="https://laravelui.spruko.com/tailwind/valex/index7" class="side-menu__item">Projects</a>
									</li>
									<li class="slide">
										<a href="https://laravelui.spruko.com/tailwind/valex/index8" class="side-menu__item">jobs</a>
									</li>
									<li class="slide">
										<a href="https://laravelui.spruko.com/tailwind/valex/index9" class="side-menu__item">Stocks</a>
									</li>
									<li class="slide">
										<a href="https://laravelui.spruko.com/tailwind/valex/index10" class="side-menu__item">Course</a>
									</li>
									<li class="slide">
										<a href="https://laravelui.spruko.com/tailwind/valex/index11" class="side-menu__item">Personal</a>
									</li>
								</ul>
							</li>
							...
							<!-- Start::slide -->
							<li class="slide">
								<a href="https://laravelui.spruko.com/tailwind/valex/icons" class="side-menu__item">
									<svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"><path d="M0 0h24v24H0V0z" fill="none"></path><path d="M12 4c-4.42 0-8 3.58-8 8s3.58 8 8 8 8-3.58 8-8-3.58-8-8-8zm3.5 4c.83 0 1.5.67 1.5 1.5s-.67 1.5-1.5 1.5-1.5-.67-1.5-1.5.67-1.5 1.5-1.5zm-7 0c.83 0 1.5.67 1.5 1.5S9.33 11 8.5 11 7 10.33 7 9.5 7.67 8 8.5 8zm3.5 9.5c-2.33 0-4.32-1.45-5.12-3.5h1.67c.7 1.19 1.97 2 3.45 2s2.76-.81 3.45-2h1.67c-.8 2.05-2.79 3.5-5.12 3.5z" opacity=".3"></path><circle cx="15.5" cy="9.5" r="1.5"></circle><circle cx="8.5" cy="9.5" r="1.5"></circle><path d="M12 16c-1.48 0-2.75-.81-3.45-2H6.88c.8 2.05 2.79 3.5 5.12 3.5s4.32-1.45 5.12-3.5h-1.67c-.69 1.19-1.97 2-3.45 2zm-.01-14C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z"></path></svg>
								...
								<ul class="slide-menu child1">
									...
									<li class="slide has-sub">
										...
										<ul class="slide-menu child2">
											<li class="slide">
												<a href="https://laravelui.spruko.com/tailwind/valex/apex-line-charts" class="side-menu__item">Line Charts</a>
											</li>
											<li class="slide">
												<a href="https://laravelui.spruko.com/tailwind/valex/apex-area-charts" class="side-menu__item">Area Charts</a>
											</li>
											<li class="slide">
												<a href="https://laravelui.spruko.com/tailwind/valex/apex-column-charts" class="side-menu__item">Column Charts</a>
											</li>
											<li class="slide">
												<a href="https://laravelui.spruko.com/tailwind/valex/apex-bar-charts" class="side-menu__item">Bar Charts</a>
											</li>
											<li class="slide">
												<a href="https://laravelui.spruko.com/tailwind/valex/apex-mixed-charts" class="side-menu__item">Mixed Charts</a>
											</li>
											<li class="slide">
												<a href="https://laravelui.spruko.com/tailwind/valex/apex-rangearea-charts" class="side-menu__item">Range Area Charts</a>
											</li>
											<li class="slide">
												<a href="https://laravelui.spruko.com/tailwind/valex/apex-timeline-charts" class="side-menu__item">Timeline Charts</a>
											</li>
											<li class="slide">
												<a href="https://laravelui.spruko.com/tailwind/valex/apex-candlestick-charts" class="side-menu__item">CandleStick Charts</a>
											</li>
											<li class="slide">
												<a href="https://laravelui.spruko.com/tailwind/valex/apex-boxplot-charts" class="side-menu__item">Boxplot Charts</a>
											</li>
											<li class="slide">
												<a href="https://laravelui.spruko.com/tailwind/valex/apex-bubble-charts" class="side-menu__item">Bubble Charts</a>
											</li>
											<li class="slide">
												<a href="https://laravelui.spruko.com/tailwind/valex/apex-scatter-charts" class="side-menu__item">Scatter Charts</a>
											</li>
											<li class="slide">
												<a href="https://laravelui.spruko.com/tailwind/valex/apex-heatmap-charts" class="side-menu__item">Heatmap Charts</a>
											</li>
											<li class="slide">
												<a href="https://laravelui.spruko.com/tailwind/valex/apex-treemap-charts" class="side-menu__item">Treemap Charts</a>
											</li>
											<li class="slide">
												<a href="https://laravelui.spruko.com/tailwind/valex/apex-pie-charts" class="side-menu__item">Pie Charts</a>
											</li>
											<li class="slide">
												<a href="https://laravelui.spruko.com/tailwind/valex/apex-radialbar-charts" class="side-menu__item">Radialbar Charts</a>
											</li>
											<li class="slide">
												<a href="https://laravelui.spruko.com/tailwind/valex/apex-radar-charts" class="side-menu__item">Radar Charts</a>
											</li>
											<li class="slide">
												<a href="https://laravelui.spruko.com/tailwind/valex/apex-polararea-charts" class="side-menu__item">Polararea Charts</a>
											</li>
										</ul>
									</li>
									<li class="slide">
										<a href="https://laravelui.spruko.com/tailwind/valex/chartjs" class="side-menu__item">Chartjs Charts</a>
									</li>
									<li class="slide">
										<a href="https://laravelui.spruko.com/tailwind/valex/echartjs" class="side-menu__item">Echart Charts</a>
									</li>
								</ul>
							</li>
							<!-- End::slide -->
							...
							<li class="slide has-sub">
								...
								<ul class="slide-menu child1">
									...
									<li class="slide">
										<a href="https://laravelui.spruko.com/tailwind/valex/cards" class="side-menu__item">Cards</a>
									</li>
									<li class="slide">
										<a href="https://laravelui.spruko.com/tailwind/valex/draggable" class="side-menu__item">Draggable Cards</a>
									</li>
									<li class="slide">
										<a href="https://laravelui.spruko.com/tailwind/valex/full-calendar" class="side-menu__item">Calendar</a>
									</li>
									<li class="slide">
										<a href="https://laravelui.spruko.com/tailwind/valex/contacts" class="side-menu__item">Contacts</a>
									</li>
									<li class="slide">
										<a href="https://laravelui.spruko.com/tailwind/valex/notifications" class="side-menu__item">Notifications</a>
									</li>
									<li class="slide">
										<a href="https://laravelui.spruko.com/tailwind/valex/widgets" class="side-menu__item">Widgets</a>
									</li>
									<li class="slide">
										<a href="https://laravelui.spruko.com/tailwind/valex/treeview" class="side-menu__item">Treeview</a>
									</li>
									<li class="slide">
										<a href="https://laravelui.spruko.com/tailwind/valex/file-manager" class="side-menu__item">File Manager</a>
									</li>
								</ul>
							</li>
							<!-- End::slide -->
							...
							<li class="slide has-sub">
								<a href="javascript:void(0);" class="side-menu__item">
									<svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"><path d="M0 0h24v24H0V0z" fill="none"></path><path d="M6.26 9L12 13.47 17.74 9 12 4.53z" opacity=".3"></path><path d="M19.37 12.8l-7.38 5.74-7.37-5.73L3 14.07l9 7 9-7zM12 2L3 9l1.63 1.27L12 16l7.36-5.73L21 9l-9-7zm0 11.47L6.26 9 12 4.53 17.74 9 12 13.47z"></path></svg>
								...
								<ul class="slide-menu child1 mega-menu">
									...
									<li class="slide">
										<a href="https://laravelui.spruko.com/tailwind/valex/alerts" class="side-menu__item">Alerts</a>
									</li>
									<li class="slide">
										<a href="https://laravelui.spruko.com/tailwind/valex/avatars" class="side-menu__item">Avatar</a>
									</li>
									<li class="slide">
										<a href="https://laravelui.spruko.com/tailwind/valex/breadcrumb" class="side-menu__item">Breadcrumb</a>
									</li>
									<li class="slide">
										<a href="https://laravelui.spruko.com/tailwind/valex/buttons" class="side-menu__item">Buttons</a>
									</li>
									<li class="slide">
										<a href="https://laravelui.spruko.com/tailwind/valex/buttongroups" class="side-menu__item">Button Groups</a>
									</li>
									<li class="slide">
										<a href="https://laravelui.spruko.com/tailwind/valex/badge" class="side-menu__item">Badge</a>
									</li>
									<li class="slide">
										<a href="https://laravelui.spruko.com/tailwind/valex/dropdowns" class="side-menu__item">Dropdown</a>
									</li>
									<li class="slide">
										<a href="https://laravelui.spruko.com/tailwind/valex/list" class="side-menu__item">List</a>
									</li>
									<li class="slide">
										<a href="https://laravelui.spruko.com/tailwind/valex/listgroup" class="side-menu__item">List Group</a>
									</li>
									<li class="slide">
										<a href="https://laravelui.spruko.com/tailwind/valex/blockquotes" class="side-menu__item">Blockquotes</a>
									</li>
									<li class="slide">
										<a href="https://laravelui.spruko.com/tailwind/valex/navbar" class="side-menu__item">Navbar</a>
									</li>
									<li class="slide">
										<a href="https://laravelui.spruko.com/tailwind/valex/images-figures" class="side-menu__item">Images & Figures</a>
									</li>
									<li class="slide">
										<a href="https://laravelui.spruko.com/tailwind/valex/pagination" class="side-menu__item">Pagination</a>
									</li>
									<li class="slide">
										<a href="https://laravelui.spruko.com/tailwind/valex/popovers" class="side-menu__item">Popovers</a>
									</li>
									<li class="slide">
										<a href="https://laravelui.spruko.com/tailwind/valex/progress" class="side-menu__item">Progress</a>
									</li>
									<li class="slide">
										<a href="https://laravelui.spruko.com/tailwind/valex/spinners" class="side-menu__item">Spinners</a>
									</li>
									<li class="slide">
										<a href="https://laravelui.spruko.com/tailwind/valex/typography" class="side-menu__item">Typography</a>
									</li>
									<li class="slide">
										<a href="https://laravelui.spruko.com/tailwind/valex/tooltips" class="side-menu__item">Tooltips</a>
									</li>
									<li class="slide">
										<a href="https://laravelui.spruko.com/tailwind/valex/toasts" class="side-menu__item">Toasts</a>
									</li>
									<li class="slide">
										<a href="https://laravelui.spruko.com/tailwind/valex/navs-tabs" class="side-menu__item">Navs & Tabs</a>
									</li>
									<li class="slide">
										<a href="https://laravelui.spruko.com/tailwind/valex/scrollspy" class="side-menu__item">Scrollspy</a>
									</li>
									<li class="slide">
										<a href="https://laravelui.spruko.com/tailwind/valex/object-fit" class="side-menu__item">Object Fit</a>
									</li>
								</ul>
							</li>
							<!-- End::slide -->
							...
							<li class="slide has-sub">
								<a href="javascript:void(0);" class="side-menu__item">
									<svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"><path d="M0 0h24v24H0z" fill="none"></path><path d="M12 4c-4.41 0-8 3.59-8 8s3.59 8 8 8c.28 0 .5-.22.5-.5 0-.16-.08-.28-.14-.35-.41-.46-.63-1.05-.63-1.65 0-1.38 1.12-2.5 2.5-2.5H16c2.21 0 4-1.79 4-4 0-3.86-3.59-7-8-7zm-5.5 9c-.83 0-1.5-.67-1.5-1.5S5.67 10 6.5 10s1.5.67 1.5 1.5S7.33 13 6.5 13zm3-4C8.67 9 8 8.33 8 7.5S8.67 6 9.5 6s1.5.67 1.5 1.5S10.33 9 9.5 9zm5 0c-.83 0-1.5-.67-1.5-1.5S13.67 6 14.5 6s1.5.67 1.5 1.5S15.33 9 14.5 9zm4.5 2.5c0 .83-.67 1.5-1.5 1.5s-1.5-.67-1.5-1.5.67-1.5 1.5-1.5 1.5.67 1.5 1.5z" opacity=".3"></path><path d="M12 2C6.49 2 2 6.49 2 12s4.49 10 10 10c1.38 0 2.5-1.12 2.5-2.5 0-.61-.23-1.21-.64-1.67-.08-.09-.13-.21-.13-.33 0-.28.22-.5.5-.5H16c3.31 0 6-2.69 6-6 0-4.96-4.49-9-10-9zm4 13h-1.77c-1.38 0-2.5 1.12-2.5 2.5 0 .61.22 1.19.63 1.65.06.07.14.19.14.35 0 .28-.22.5-.5.5-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.14 8 7c0 2.21-1.79 4-4 4z"></path><circle cx="6.5" cy="11.5" r="1.5"></circle><circle cx="9.5" cy="7.5" r="1.5"></circle><circle cx="14.5" cy="7.5" r="1.5"></circle><circle cx="17.5" cy="11.5" r="1.5"></circle></svg>
								...
								<ul class="slide-menu child1">
									...
									<li class="slide">
										<a href="https://laravelui.spruko.com/tailwind/valex/accordions-collpase" class="side-menu__item">Accordions</a>
									</li>
									<li class="slide">
										<a href="https://laravelui.spruko.com/tailwind/valex/modals-closes" class="side-menu__item">Modals</a>
									</li>
									<li class="slide has-sub">
										...
										<ul class="slide-menu child2">
											<li class="slide">
												<a href="https://laravelui.spruko.com/tailwind/valex/timeline" class="side-menu__item">Timeline-1</a>
											</li>
											<li class="slide">
												<a href="https://laravelui.spruko.com/tailwind/valex/timeline2" class="side-menu__item">Timeline-2</a>
											</li>
										</ul>
									</li>
									<li class="slide">
										<a href="https://laravelui.spruko.com/tailwind/valex/stepper" class="side-menu__item">Stepper</a>
									</li>
									<li class="slide">
										<a href="https://laravelui.spruko.com/tailwind/valex/Indicators" class="side-menu__item">Indicators</a>
									</li>
									<li class="slide">
										<a href="https://laravelui.spruko.com/tailwind/valex/form-range" class="side-menu__item">Range Slider</a>
									</li>
									<li class="slide">
										<a href="https://laravelui.spruko.com/tailwind/valex/sweet-alerts" class="side-menu__item">Sweet Alerts</a>
									</li>
									<li class="slide">
										<a href="https://laravelui.spruko.com/tailwind/valex/ratings" class="side-menu__item">Ratings</a>
									</li>
									<li class="slide">
										<a href="https://laravelui.spruko.com/tailwind/valex/search" class="side-menu__item">Search</a>
									</li>
									<li class="slide">
										<a href="https://laravelui.spruko.com/tailwind/valex/userlist" class="side-menu__item">Userlist</a>
									</li>
									<li class="slide has-sub">
										...
										<ul class="slide-menu child2">
											<li class="slide">
												<a href="https://laravelui.spruko.com/tailwind/valex/blog" class="side-menu__item">Blog</a>
											</li>
											<li class="slide">
												<a href="https://laravelui.spruko.com/tailwind/valex/blog-details" class="side-menu__item">Blog Details</a>
											</li>
											<li class="slide">
												<a href="https://laravelui.spruko.com/tailwind/valex/blog-create" class="side-menu__item">Blog Create</a>
											</li>
										</ul>
									</li>
									<li class="slide">
										<a href="https://laravelui.spruko.com/tailwind/valex/offcanvas" class="side-menu__item">Offcanvas</a>
									</li>
									<li class="slide">
										<a href="https://laravelui.spruko.com/tailwind/valex/skeleton" class="side-menu__item">Skeleton</a>
									</li>
									<li class="slide">
										<a href="https://laravelui.spruko.com/tailwind/valex/swiperjs" class="side-menu__item">Swiper JS</a>
									</li>
								</ul>
							</li>
							<!-- End::slide -->
							...
							<!-- End::slide -->
								...
								<li class="slide has-sub">
									...
									<ul class="slide-menu child1">
										...
										<li class="slide">
											<a href="https://laravelui.spruko.com/tailwind/valex/profile" class="side-menu__item">Profile</a>
										</li>
										<li class="slide">
											<a href="https://laravelui.spruko.com/tailwind/valex/about-us" class="side-menu__item">About-Us</a>
										</li>
										<li class="slide">
											<a href="https://laravelui.spruko.com/tailwind/valex/reviews" class="side-menu__item">Review</a>
										</li>
										<li class="slide">
											<a href="https://laravelui.spruko.com/tailwind/valex/team" class="side-menu__item">Team</a>
										</li>
										<li class="slide has-sub">
											...
											<ul class="slide-menu child2">
												<li class="slide">
													<a href="https://laravelui.spruko.com/tailwind/valex/create-invoice" class="side-menu__item">Create Invoice</a>
												</li>
												<li class="slide">
													<a href="https://laravelui.spruko.com/tailwind/valex/invoice-details" class="side-menu__item">Invoice Details</a>
												</li>
												<li class="slide">
													<a href="https://laravelui.spruko.com/tailwind/valex/invoice-list" class="side-menu__item">Invoice List</a>
												</li>
											</ul>
										</li>
										<li class="slide">
											<a href="https://laravelui.spruko.com/tailwind/valex/pricing" class="side-menu__item">Pricing</a>
										</li>
										<li class="slide">
											<a href="https://laravelui.spruko.com/tailwind/valex/gallery" class="side-menu__item">Gallery</a>
										</li>
										<li class="slide">
											<a href="https://laravelui.spruko.com/tailwind/valex/todolist" class="side-menu__item">TodoList</a>
										</li>
										<li class="slide has-sub">
											...
											<ul class="slide-menu child2">
												<li class="slide">
													<a href="https://laravelui.spruko.com/tailwind/valex/task-kanban-board" class="side-menu__item">Kanban Board</a>
												</li>
												<li class="slide">
													<a href="https://laravelui.spruko.com/tailwind/valex/task-list-view" class="side-menu__item">List View</a>
												</li>
												<li class="slide">
													<a href="https://laravelui.spruko.com/tailwind/valex/task-details" class="side-menu__item">Task Details</a>
												</li>
											</ul>
										</li>
										<li class="slide">
											<a href="https://laravelui.spruko.com/tailwind/valex/faqs" class="side-menu__item">Faqs</a>
										</li>
										<li class="slide">
											<a href="https://laravelui.spruko.com/tailwind/valex/emptypage" class="side-menu__item">Empty</a>
										</li>
										<li class="slide has-sub">
											...
											<ul class="slide-menu child2">
												<li class="slide">
													<a href="https://laravelui.spruko.com/tailwind/valex/mail" class="side-menu__item">Mail</a>
												</li>
												<li class="slide">
													<a href="https://laravelui.spruko.com/tailwind/valex/mail-settings" class="side-menu__item">Mail Settings</a>
												</li>
												<li class="slide">
													<a href="https://laravelui.spruko.com/tailwind/valex/chat" class="side-menu__item">Chat</a>
												</li>
											</ul>
										</li>
										<li class="slide has-sub">
											...
											<ul class="slide-menu child2">
												<li class="slide">
													<a href="https://laravelui.spruko.com/tailwind/valex/products" class="side-menu__item">Products</a>
												</li>
												<li class="slide">
													<a href="https://laravelui.spruko.com/tailwind/valex/products-list" class="side-menu__item">Products List</a>
												</li>
												<li class="slide">
													<a href="https://laravelui.spruko.com/tailwind/valex/add-products" class="side-menu__item">Add Products</a>
												</li>
												<li class="slide">
													<a href="https://laravelui.spruko.com/tailwind/valex/edit-products" class="side-menu__item">Edit Products</a>
												</li>
												<li class="slide">
													<a href="https://laravelui.spruko.com/tailwind/valex/product-details" class="side-menu__item">Product Details</a>
												</li>
												<li class="slide">
													<a href="https://laravelui.spruko.com/tailwind/valex/orders" class="side-menu__item">Orders</a>
												</li>
												<li class="slide">
													<a href="https://laravelui.spruko.com/tailwind/valex/order-details" class="side-menu__item">Order Details</a>
												</li>
												<li class="slide">
													<a href="https://laravelui.spruko.com/tailwind/valex/product-cart" class="side-menu__item">Cart</a>
												</li>
												<li class="slide">
													<a href="https://laravelui.spruko.com/tailwind/valex/check-out" class="side-menu__item">Check-out</a>
												</li>
												<li class="slide">
													<a href="https://laravelui.spruko.com/tailwind/valex/wish-list" class="side-menu__item">Wish List</a>
												</li>
											</ul>
										</li>
										<li class="slide has-sub">
											...
											<ul class="slide-menu child2">
												<li class="slide">
													<a href="https://laravelui.spruko.com/tailwind/valex/comingsoon" class="side-menu__item">Coming Soon</a>
												</li>
												<li class="slide has-sub">
													...
													<ul class="slide-menu child3">
														<li class="slide">
															<a href="https://laravelui.spruko.com/tailwind/valex/create-password-basic" class="side-menu__item">Basic</a>
														</li>
														<li class="slide">
															<a href="https://laravelui.spruko.com/tailwind/valex/create-password-cover" class="side-menu__item">Cover</a>
														</li>
													</ul>
												</li>
												<li class="slide has-sub">
													...
													<ul class="slide-menu child3">
														<li class="slide">
															<a href="https://laravelui.spruko.com/tailwind/valex/sign-in-basic" class="side-menu__item">Basic</a>
														</li>
														<li class="slide">
															<a href="https://laravelui.spruko.com/tailwind/valex/sign-in-cover" class="side-menu__item">Cover</a>
														</li>
													</ul>
												</li>
												<li class="slide has-sub">
													...
													<ul class="slide-menu child3">
														<li class="slide">
															<a href="https://laravelui.spruko.com/tailwind/valex/sign-up-basic" class="side-menu__item">Basic</a>
														</li>
														<li class="slide">
															<a href="https://laravelui.spruko.com/tailwind/valex/sign-up-cover" class="side-menu__item">Cover</a>
														</li>
													</ul>
												</li>
												<li class="slide has-sub">
													...
													<ul class="slide-menu child3">
														<li class="slide">
															<a href="https://laravelui.spruko.com/tailwind/valex/reset-password-basic" class="side-menu__item">Basic</a>
														</li>
														<li class="slide">
															<a href="https://laravelui.spruko.com/tailwind/valex/reset-password-cover" class="side-menu__item">Cover</a>
														</li>
													</ul>
												</li>
												<li class="slide has-sub">
													...
													<ul class="slide-menu child3">
														<li class="slide">
															<a href="https://laravelui.spruko.com/tailwind/valex/lockscreen-basic" class="side-menu__item">Basic</a>
														</li>
														<li class="slide">
															<a href="https://laravelui.spruko.com/tailwind/valex/lockscreen-cover" class="side-menu__item">Cover</a>
														</li>
													</ul>
												</li>
												<li class="slide has-sub">
													...
													<ul class="slide-menu child3">
														<li class="slide">
															<a href="https://laravelui.spruko.com/tailwind/valex/two-step-verfication-basic" class="side-menu__item">Basic</a>
														</li>
														<li class="slide">
															<a href="https://laravelui.spruko.com/tailwind/valex/two-step-verfication-cover" class="side-menu__item">Cover</a>
														</li>
													</ul>
												</li>
												<li class="slide">
													<a href="https://laravelui.spruko.com/tailwind/valex/maintanace" class="side-menu__item">Under Maintenance</a>
												</li>
												<li class="slide has-sub">
													...
													<ul class="slide-menu child3">
														<li class="slide">
															<a href="https://laravelui.spruko.com/tailwind/valex/error404" class="side-menu__item">404 Error</a>
														</li>
														<li class="slide">
															<a href="https://laravelui.spruko.com/tailwind/valex/error500" class="side-menu__item">500 Error</a>
														</li>
														<li class="slide">
															<a href="https://laravelui.spruko.com/tailwind/valex/error501" class="side-menu__item">501 Error</a>
														</li>
													</ul>
												</li>
										...
										<li class="slide">
											<a href="https://laravelui.spruko.com/tailwind/valex/terms" class="side-menu__item">Terms & Conditions</a>
										</li>
									</ul>
								</li>
								<!-- End::slide -->
							...
							<li class="slide has-sub">
								...
								<ul class="slide-menu child1">
									...
									<li class="slide has-sub">
										...
										<ul class="slide-menu child2">
											<li class="slide">
												<a href="https://laravelui.spruko.com/tailwind/valex/form-inputs" class="side-menu__item">Inputs</a>
											</li>
											<li class="slide">
												<a href="https://laravelui.spruko.com/tailwind/valex/form-check-radios" class="side-menu__item">Checks & Radios</a>
											</li>
											<li class="slide">
												<a href="https://laravelui.spruko.com/tailwind/valex/form-input-group" class="side-menu__item">Input Group</a>
											</li>
											<li class="slide">
												<a href="https://laravelui.spruko.com/tailwind/valex/form-select" class="side-menu__item">Form Select</a>
											</li>
											<li class="slide">
												<a href="https://laravelui.spruko.com/tailwind/valex/form-file-uploads" class="side-menu__item">File Uploads</a>
											</li>
											<li class="slide">
												<a href="https://laravelui.spruko.com/tailwind/valex/form-datetime-pickers" class="side-menu__item">Date,Time Picker</a>
											</li>
											<li class="slide">
												<a href="https://laravelui.spruko.com/tailwind/valex/form-color-pickers" class="side-menu__item">Color Pickers</a>
											</li>
											<li class="slide">
												<a href="https://laravelui.spruko.com/tailwind/valex/advanced-select" class="side-menu__item">Advanced Select</a>
											</li>
											<li class="slide">
												<a href="https://laravelui.spruko.com/tailwind/valex/inputnumber" class="side-menu__item">Input Number</a>
											</li>
											<li class="slide">
												<a href="https://laravelui.spruko.com/tailwind/valex/passwords" class="side-menu__item">Passwords</a>
											</li>
											<li class="slide">
												<a href="https://laravelui.spruko.com/tailwind/valex/counters" class="side-menu__item">Counters & Markup</a>
											</li>
										</ul>
									</li>
									<li class="slide">
										<a href="https://laravelui.spruko.com/tailwind/valex/form-layout" class="side-menu__item">Form Layouts</a>
									</li>
									<li class="slide has-sub">
										...
										<ul class="slide-menu child2">
											<li class="slide">
												<a href="https://laravelui.spruko.com/tailwind/valex/quill-editor" class="side-menu__item">Quill Editor</a>
											</li>
										</ul>
									</li>
									<li class="slide">
										<a href="https://laravelui.spruko.com/tailwind/valex/form-validation" class="side-menu__item">Validation</a>
									</li>
									<li class="slide">
										<a href="https://laravelui.spruko.com/tailwind/valex/form-select2" class="side-menu__item">Select2</a>
									</li>
								</ul>
							</li>
							<!-- End::slide -->
							...
							<li class="slide has-sub">
								...
								<ul class="slide-menu child1">
									...
									<li class="slide">
										<a href="https://laravelui.spruko.com/tailwind/valex/tables" class="side-menu__item">Tables</a>
									</li>
									<li class="slide">
										<a href="https://laravelui.spruko.com/tailwind/valex/grid-tables" class="side-menu__item">Grid JS Tables</a>
									</li>
									<li class="slide">
										<a href="https://laravelui.spruko.com/tailwind/valex/data-tables" class="side-menu__item">Data Tables</a>
									</li>
									<li class="slide">
										<a href="https://laravelui.spruko.com/tailwind/valex/edittable" class="side-menu__item">Edit Table</a>
									</li>
								</ul>
							</li>
							<!-- End::slide -->
							...
							<!-- Start::slide -->
							<li class="slide">
								<a href="https://laravelui.spruko.com/tailwind/valex/landing" class="side-menu__item">
									<svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"><path d="M0 0h24v24H0z" fill="none"></path><path d="M12 4.02C7.6 4.02 4.02 7.6 4.02 12S7.6 19.98 12 19.98s7.98-3.58 7.98-7.98S16.4 4.02 12 4.02zM11.39 19v-5.5H8.25l4.5-8.5v5.5h3L11.39 19z" opacity=".3"></path><path d="M12 2.02c-5.51 0-9.98 4.47-9.98 9.98s4.47 9.98 9.98 9.98 9.98-4.47 9.98-9.98S17.51 2.02 12 2.02zm0 17.96c-4.4 0-7.98-3.58-7.98-7.98S7.6 4.02 12 4.02 19.98 7.6 19.98 12 16.4 19.98 12 19.98zM12.75 5l-4.5 8.5h3.14V19l4.36-8.5h-3V5z"></path></svg>
							...
							<li class="slide has-sub">
								<a href="javascript:void(0);" class="side-menu__item">
									<svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"><path d="M0 0h24v24H0V0z" fill="none"></path><path d="M12 4C9.24 4 7 6.24 7 9c0 2.85 2.92 7.21 5 9.88 2.11-2.69 5-7 5-9.88 0-2.76-2.24-5-5-5zm0 7.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z" opacity=".3"></path><path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zM7 9c0-2.76 2.24-5 5-5s5 2.24 5 5c0 2.88-2.88 7.19-5 9.88C9.92 16.21 7 11.85 7 9z"></path><circle cx="12" cy="9" r="2.5"></circle></svg>
								...
								<ul class="slide-menu child1">
									...
									<li class="slide">
										<a href="https://laravelui.spruko.com/tailwind/valex/google-maps" class="side-menu__item">Google Maps</a>
									</li>
									<li class="slide">
										<a href="https://laravelui.spruko.com/tailwind/valex/leaflet-maps" class="side-menu__item">Leaflet Maps</a>
									</li>
									<li class="slide">
										<a href="https://laravelui.spruko.com/tailwind/valex/vector-maps" class="side-menu__item">Vector Maps</a>
									</li>
								</ul>
							</li>
							<!-- End::slide -->
							...
							<li class="slide has-sub">
								...
								<ul class="slide-menu child1">
									...
									<li class="slide">
										<a href="https://laravelui.spruko.com/tailwind/valex/borders" class="side-menu__item">Borders</a>
									</li>
									<li class="slide">
										<a href="https://laravelui.spruko.com/tailwind/valex/colors" class="side-menu__item">Colors</a>
									</li>
									<li class="slide">
										<a href="https://laravelui.spruko.com/tailwind/valex/columns" class="side-menu__item">Columns</a>
									</li>
									<li class="slide">
										<a href="https://laravelui.spruko.com/tailwind/valex/flex" class="side-menu__item">Flex</a>
									</li>
									<li class="slide">
										<a href="https://laravelui.spruko.com/tailwind/valex/grids" class="side-menu__item">Grid</a>
									</li>
								</ul>
							</li>
							<!-- End::slide -->
