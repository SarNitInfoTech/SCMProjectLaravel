...
<head>
    ...
    <link rel="preload" as="style" href="css/app-BEmGdVaN.css">
    <link rel="stylesheet" href="css/app-BEmGdVaN.css">
...
<body>
    <div id="hs-overlay-switcher" class="hs-overlay hidden ti-offcanvas ti-offcanvas-right !border-0" tabindex="-1">
        ...
        <div class="ti-offcanvas-footer gap-4 sm:flex justify-between">
            <a href="https://1.envato.market/Bn1zey" target="_blank" class="w-full ti-btn ti-btn-primary-full m-1">Buy
                Now</a>
            <a href="https://1.envato.market/MGEaN" target="_blank" class="w-full ti-btn ti-btn-info-full m-1">Our
                Portfolio</a>
    ...
    <link rel="modulepreload" href="https://laravelui.spruko.com/tailwind/valex/build/assets/us-merc-en-V0CEs0pf.js">
    <script type="module" src="js/us-merc-en-V0CEs0pf.js"></script>
    <link rel="modulepreload" href="https://laravelui.spruko.com/tailwind/valex/build/assets/index-ChlSDD4z.js">
    <script type="module" src="js/index-ChlSDD4z.js"></script>
    <script src="js/sticky.js"></script>
    <link rel="modulepreload" href="https://laravelui.spruko.com/tailwind/valex/build/assets/custom-switcher-DhReuTTH.js">
    <script type="module" src="js/custom-switcher-DhReuTTH.js"></script>
    <link rel="modulepreload" href="https://laravelui.spruko.com/tailwind/valex/build/assets/app-CLk324ZP.js">
    <script type="module" src="js/app-CLk324ZP.js"></script>
</body>
</html>