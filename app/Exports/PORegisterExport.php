...
class PORegisterExport implements FromView
{
    ...
    public function __construct($indent_id, $department_id)
    {
    ...
    public function view(): View
{
    ...
    ->leftJoin('units', 'units.id', '=', 'indent_registers.unit') // only if `unit` stores ID
    ->select(
        // PO Register Fields
        ...
        'units.name as unit_name', // from units table
    ...
    ->where('po_registers.indent_id', $this->indent_id)
    ->where('po_registers.department_id', $this->department_id)
